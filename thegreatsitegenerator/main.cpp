...
int main(int argc, const char** argv)
{
    ...
    if (argv[1] == "-h"sv || argv[1] == "--help"sv) {
        cout << "Please type -i followed by the name of the the text file or "
                "folder.\n";
        cout << "Please type -m followed by the name of the the markdown file or "
                "folder.\n";
    } else if (argv[1] == "-v"sv || argv[1] == "--version"sv) {
        cout << "Version " << TGSG_VERSION_MAJOR << "." << TGSG_VERSION_MINOR
             << endl;
        ...
        if (filesystem::exists(argv[2])) {
            ...
            cout << "\033[1mALL DONE!\033[0m\nYour GREAT html has been placed in the "
                    "dist folder.\nHave a wonderful day :)\n";
        } else {
            cerr
                << "File or folder does not exist. Type -h for more details.\n"; // Identify
                                                                                 // user
            return 1;
        }
